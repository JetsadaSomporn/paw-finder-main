        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-[#F4A261] hover:text-[#6C4F3D] transition-colors duration-200"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.051 10.051 0 01-3.126 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                </svg>
              </a>
              <a
                href="#"
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#6C4F3D] mb-4">
              เมนูหลัก
            </h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-[#3E3E3E] hover:text-[#F4A261] transition-colors duration-200"
                >
                  หน้าหลัก
                </a>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#3E3E3E]">095-2488080</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-[#F4A261]" />
                <span className="text-[#3E3E3E]">pawfinder.contact@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
